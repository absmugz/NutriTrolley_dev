...
<title>Codeigniter Forms Preview</title>
...
.error p{font-size:10px;padding-left:0px;}
</style>
...
<div style="height:100px;padding-top: 40px; height: 58px;" class="text-center alert">
 <h2>Header Area</h2>
</div>  
    <!-- end .header --></div>
