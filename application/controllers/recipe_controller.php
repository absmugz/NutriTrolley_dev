...
class Recipe_controller extends CI_Controller {
	...
	function index()
	{			
		$this->form_validation->set_rules('recipe_name', 'recipe name', 'required|trim|max_length[255]');
			$this->thumbnail="";
		...
		$this->form_validation->set_rules('ready_to_eat_in', 'Ready to eat in', 'required|trim|max_length[255]');			
		...
		$this->form_validation->set_rules('shopping', 'shopping', 'required|trim|max_length[255]');			
		$this->form_validation->set_rules('shopping_date', 'shopping_date', 'required|trim');			
